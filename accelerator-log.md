...
┃ ┃ ┃ ┃ ┃ ┗ Debug test.sh matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[0].<combo>.transformations[1] (Exclude)
┃ ┃ ┃ ┃ ┃ ┃  Info Will exclude [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh]
┃ ┃ ┃ ┃ ┃ ┃ Debug .gitignore didn't match [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> included
┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> included
┃ ┃ ┃ ┃ ┃ ┃ Debug DEPLOYING.md matched [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> included
┃ ┃ ┃ ┃ ┃ ┃ Debug README.md matched [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug Tiltfile didn't match [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> included
┃ ┃ ┃ ┃ ┃ ┃ Debug catalog/catalog-info.yaml matched [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug config/workload.yaml matched [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug index.js didn't match [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> included
┃ ┃ ┃ ┃ ┃ ┃ Debug package.json matched [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> excluded
┃ ┃ ┃ ┃ ┗ ┗ Debug test.sh matched [package.json, config/**, catalog/**, README.md, DEPLOYING.md, test.sh] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Tiltfile didn't match [package.json] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ Debug index.js didn't match [config/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug package.json didn't match [config/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┗ Debug test.sh didn't match [config/workload.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ Debug index.js didn't match [catalog/catalog-info.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug package.json didn't match [catalog/catalog-info.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┗ Debug test.sh didn't match [catalog/catalog-info.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┗ Debug test.sh didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug index.js didn't match [README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug package.json didn't match [README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ Debug test.sh didn't match [README.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug index.js didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug package.json didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ Debug test.sh didn't match [DEPLOYING.md] -> excluded
